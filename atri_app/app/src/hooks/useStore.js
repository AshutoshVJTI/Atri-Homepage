...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox13": {
      "custom": {
        "text": "Your text Here!Lorem ipsum dolor sit amet consectetur adipiscing elit ugue quam diam vitae velit bibendum elementum eget non vivamus volutpat odio cras vestibulum purus aliquam."
      },
      "callbacks": {
        "onClick": [
          {
